    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <AstroCard>
                <h1>Donate</h1>
                <hr/>
                <p>Jessy OS is an open-source project and is voluntarily developed. If you find Jessy OS useful and would like to support its continued development and improvement, you can make a donation.</p>
                <br/>

                <center>
                    <a href="https://www.buymeacoffee.com/nthnn" target="_blank">
